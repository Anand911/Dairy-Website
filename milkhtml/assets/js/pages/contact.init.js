...
document.getElementById("recomended-jobs") && (contactList = new gridjs.Grid({
    columns: [{
        name: "Name",
        data: function(e) {
            return gridjs.html('<div class="d-flex align-items-center">\t\t\t\t\t\t<div class="flex-grow-1">\t\t\t\t\t\t<h6 class="fw-medium mb-1 user-name">' + e.user.name + "</h6>\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>")
        }
    }, {
        name: "Email"
    }, {
...
searchProductList.addEventListener("keyup", function() {
    ...
    var a, e = contactData.filter(function(e) {
        return -1 !== e.user.name.toLowerCase().indexOf(a.toLowerCase()) || -1 !== e.email.toLowerCase().indexOf(a.toLowerCase()) || -1 !== e.phone.toLowerCase().indexOf(a.toLowerCase()) || -1 !== e.country.toLowerCase().indexOf(a.toLowerCase()) || -1 !== e.label.toLowerCase().indexOf(a.toLowerCase())
    });
    contactList.updateConfig({
        data: e
    }).forceRender()
